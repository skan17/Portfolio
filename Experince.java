...
public class Experince extends JFrame {
	...
	public Experince() {
		...
		lblFirstName = new JLabel("Skill_1");
		...
		lblFirstName_2 = new JLabel("Skill_2");
		...
		lblFirstName_3 = new JLabel("Skill_3");
		...
		lblFirstName_4.setBounds(445, 380, 226, 41);
		...
		textField_4.setBounds(445, 420, 209, 41);
		...
		lblNewLabel_1 = new JLabel("Resume Generator");
